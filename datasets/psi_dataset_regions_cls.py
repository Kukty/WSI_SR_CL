...
@dataclass
class PSIRegionClsDatasetParams(PSIDatasetParams):
    """Class that controls parameters of PSIRegionClsDataset.
...
class PSIRegionClsDataset:
    ...
    def __init__(self, params: PSIRegionClsDatasetParams, quiet=False) -> None:
        self.params = params
        self.quiet = quiet
